    ...
    class Formula
    {
        ...
        public $hipert;                 // população hipertensão
          ...
          public function section_2_8_C($table, $row_style, $style, $size)
          {
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Dosagem de potássio sérico',                                        'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*1),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Gasometria venosa',                                                 'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*1),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Dosagem de creatina',                                               'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*2),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Dosagem de hemoglobina',                                            'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*1),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Dosagem de hematócrito',                                            'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*1),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Dosagem de paratormonio sérico',                                    'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*1),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Dosagem de cálcio ionico sérico',                                   'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*1),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Dosagem de albumina sérica',                                        'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*1),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Ferritina',                                                         'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*1),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Índice de saturação de transferrina',                               'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*1),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Pesquisa de anticorpos Anti-HIV (western blot)',                    'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*0),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Uréia',                                                             'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*2),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Fósforo',                                                           'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*1),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('AntiHbs',                                                          'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.001*1),                                            'left', $style, $size/2);
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('AntiHcv',                                                           'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*0),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('HBsAg',                                                             'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*0),                                            'left', $style, $size/2);
               ...
               $table->addRow();
               $table->addCell('Laboratorial',                                                      'left', $row_style, $size+2);
               $table->addCell('Vitamina D',                                                        'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*0),                                            'left', $style, $size/2);
               ...
               $table->addCell('Ultrassom rins e vias urinarias',                                   'left', $style, $size*6 +3);
               $table->addCell(ceil($this->aux*0.121*1),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.096*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.009*0),                                            'left', $style, $size/2);
               $table->addCell(ceil($this->aux*0.015*0),                                            'left', $style, $size/2);
